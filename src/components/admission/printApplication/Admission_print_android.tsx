...
//             <td class="para-head">Percentile</td>
...
//
//           <tr>
//             <td class="para-head">Physics Percentile</td>
//             <td>{entrance[i].phy_per}</td>
//             <td class="para-head">Chemistry Percentile </td>
//             <td>{entrance[i].che_per}</td>
//           </tr>
//           <tr>
//             <td class="para-head">Maths Percentile </td>
...
//                 <td>{raddress.address}</td>
//                 <td class="para-head">Address</td>
//                 <td>{paddress.address}</td>
//               </tr>
//               <tr></tr>
//             </tbody>
//           </table>
...
//           <table class="GeneratedTable">
//             <tbody>
//               <th class="tableHead">Documents Submitted</th>
//
//               <tr>
//                 <td>Cap Allotment Letter</td>
//                 <td>
//                   {docs.cap_allotment_letter != null && docs.cap_allotment_letter.trim() !== '' ? (
//                     <button style={{ padding: "2px" }}>
//                       <a
//                         style={{ textDecoration: "none" }}
//                         href={docs.cap_allotment_letter}
//                         target="_blank"
//                       >
//                         Yes
//                       </a>{" "}
...
//                 <td>
//                   {docs.fc_center_varification != null && docs.fc_center_varification.trim() !== '' ? (
//                     <button style={{ padding: "2px" }}>
//                       <a
//                         style={{ textDecoration: "none" }}
//                         href={docs.fc_center_varification}
//                         target="_blank"
//                       >
//                         Yes
//                       </a>{" "}
...
//                 <td>SSC Marksheet</td>
//                 <td>
//                   {docs.ssc_marksheet != null && docs.ssc_marksheet.trim() !== '' ? (
//                     <button style={{ padding: "2px" }}>
//                       <a
//                         style={{ textDecoration: "none" }}
//                         href={docs.ssc_marksheet}
//                         target="_blank"
//                       >
//                         Yes
//                       </a>{" "}
...
//                 <td>HSC Marksheet</td>
//                 <td>
//                   {docs.hsc_marksheet != null && docs.hsc_marksheet.trim() !== '' ? (
//                     <button style={{ padding: "2px" }}>
//                       <a
//                         style={{ textDecoration: "none" }}
//                         href={docs.hsc_marksheet}
//                         target="_blank"
//                       >
//                         Yes
//                       </a>{" "}
...
//                 <td>
//                   {docs.mht_cet_score_card != null && docs.mht_cet_score_card.trim() !== '' ? (
//                     <button style={{ padding: "2px" }}>
//                       <a
//                         style={{ textDecoration: "none" }}
//                         href={docs.mht_cet_score_card}
//                         target="_blank"
//                       >
//                         Yes
//                       </a>{" "}
...
//                 <td>Domicle</td>
//                 <td>
//                   {docs.domicile != null && docs.domicile.trim() !== '' ? (
//                     <button style={{ padding: "2px" }}>
//                       <a
//                         style={{ textDecoration: "none" }}
//                         href={docs.domicile}
...
//                 <td>Aadhar Card</td>
//                 <td>
//                   {docs.aadhar_card != null && docs.aadhar_card.trim() !== '' ? (
//                     <button style={{ padding: "2px" }}>
//                       <a
//                         style={{ textDecoration: "none" }}
//                         href={docs.aadhar_card}
//                         target="_blank"
//                       >
//                         Yes
//                       </a>{" "}
...
//                 <td>Ration card</td>
//                 <td>
//                   {docs.ration_card != null && docs.ration_card.trim() !== '' ? (
//                     <button style={{ padding: "2px" }}>
//                       <a
//                         style={{ textDecoration: "none" }}
//                         href={docs.ration_card}
//                         target="_blank"
//                       >
//                         Yes
//                       </a>{" "}
...
//                 <td>Bank Passbook</td>
//                 <td>
//                   {docs.back_passbook != null && docs.back_passbook.trim() !== '' ? (
//                     <button style={{ padding: "2px" }}>
//                       <a
//                         style={{ textDecoration: "none" }}
//                         href={docs.back_passbook}
//                         target="_blank"
//                       >
//                         Yes
//                       </a>{" "}
...
//                 <td>
//                   {docs.jee_score_card != null && docs.jee_score_card.trim() !== '' ? (
//                     <button style={{ padding: "2px" }}>
//                       <a
//                         style={{ textDecoration: "none" }}
//                         href={docs.jee_score_card}
//                         target="_blank"
//                       >
//                         Yes
//                       </a>{" "}
...
//                 <td>Results</td>
//                 <td>
//                   {docs.fee_reciept != null && docs.fee_reciept.trim() !== '' ? (
//                     <button style={{ padding: "2px" }}>
//                       <a
//                         style={{ textDecoration: "none" }}
//                         href={docs.fee_reciept}
//                         target="_blank"
//                       >
//                         Yes
//                       </a>{" "}
...
//                 <td>
//                   {docs.college_admission_letter != null && docs.college_admission_letter.trim() !== '' ? (
//                     <button style={{ padding: "2px" }}>
//                       <a
//                         style={{ textDecoration: "none" }}
//                         href={docs.college_admission_letter}
//                         target="_blank"
//                       >
//                         Yes
//                       </a>{" "}
...
//                     <td>
//                       {docs.caste_certificate != null && docs.caste_certificate.trim() !== '' ? (
//                         <button style={{ padding: "2px" }}>
//                           <a
//                             style={{ textDecoration: "none" }}
//                             href={docs.cap_allotment_letter}
...
//                     <td>
//                       {docs.caste_validation != null && docs.caste_validation.trim() !== '' ? (
//                         <button style={{ padding: "2px" }}>
//                           <a
//                             style={{ textDecoration: "none" }}
//                             href={docs.cap_allotment_letter}
...
//                       <td>
//                         {docs.nonCreamy != null && docs.nonCreamy.trim() !== ""? (
//                           <button style={{ padding: "2px" }}>
//                             <a
//                               style={{ textDecoration: "none" }}
//                               href={docs.cap_allotment_letter}
...
//                   <td>
//                     {docs.ews_pro != null && docs.ews_pro.trim() !== "" ? (
//                       <button style={{ padding: "2px" }}>
//                         <a
//                           style={{ textDecoration: "none" }}
//                           href={docs.cap_allotment_letter}
...
//                     <td>
//                       {docs.income_certificate != null && docs.income_certificate.trim() !== "" ? (
//                         <button style={{ padding: "2px" }}>
//                           <a
//                             style={{ textDecoration: "none" }}
//                             href={docs.cap_allotment_letter}
